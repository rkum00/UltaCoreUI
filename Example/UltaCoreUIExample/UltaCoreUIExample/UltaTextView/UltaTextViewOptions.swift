...
public enum UltaTextViewOptions: String, CaseIterable {
    ...
    func getTextVariations(row: Int) -> UBText {
        ...
        case 0:
            ...
            return text
        case 1:
            let text = UBText(textAttribute: TextAttributes(text: "Text can supprot Link1 and Link2."), linkAttributes: [LinkAttributes(text: "Link1", url: "Row 0"), LinkAttributes(text: "Link2", url: "https://www.albertsonscompanies.com/about-us/our-policies/terms-of-use.html")])
            return text
        case 2:
            let text = UBText(textAttribute: TextAttributes(text: "Text can support links in multiple lines.Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat: Link1"), linkAttributes: [LinkAttributes(text: "support", url: "https://www.albertsonscompanies.com/about-us/our-policies/terms-of-use.html"), LinkAttributes(text: "veniam", url: "veniam"), LinkAttributes(text: "Link1", url: "Link1")])
            return text
        default:
